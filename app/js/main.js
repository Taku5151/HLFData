...
function executequery() {
  ...
  demandDS.addFilter("Month", `<='${UtilGetSQLDate(new Date(toDate.getFullYear(), toDate.getMonth() + 6, toDate.getDate()))}'`);
  ...
  invlineDS.addFilter("Month", `>='${UtilGetSQLDate(new Date(fromDate.getFullYear(), fromDate.getMonth() - 1, fromDate.getDate()))}'`);
